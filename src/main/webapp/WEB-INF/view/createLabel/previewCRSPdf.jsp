	...
	for(var i=0;i<airBottleJA.length;i++){
		...
		$.post("selectCRSPdfSet",
			...
			function(data){
                ...
                previewPdfDiv.append("<div id=\"pdf_div"+airBottleJO.qpbh+"\" zzrqY=\""+airBottleJO.zzrq_y+"\" zzrqM=\""+airBottleJO.zzrq_m+"\" style=\"width:500px;height: 708.75px;font-size: 20px;margin:0 auto;border:#000 solid 1px;\">"
